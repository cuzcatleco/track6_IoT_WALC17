**Persistencia de Datos**: Escritura en `/flash` o tarjeta `/SD` del dispositivo LoPy.

# Persistencia de Datos

## Introduccion
Mienstras que uno de los propositos principales del IoT es la recoleccion e intercambio de datos atraves de una red inter-conectada, es tambien importante 
el almacenamiento de datos dentro del propio dispositivo de IoT: archivos log sobre actividad del dispositivo, niveles de señales, mediciones ...
...
* if the user pushes the button the incremented counter is saved;
